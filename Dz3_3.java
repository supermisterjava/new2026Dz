...
public class Dz3_3 {
    public static void main(String[] args) {
        int a = 42;
        if (a > 10) {
            System.out.println("a больше 10 - если переменная больше 10");
        }
        if (a < 100) {
            System.out.println("a меньше 100 - если переменная меньше 100");
        }
        if (a / 2 > 20) {
            System.out.println("результат деления на 2 больше 20 - если это соответствует истине");
        } else  {
            System.out.println("результат деления на 2 больше 20 - если это соответствует истине (False)");
        }
        if (a >= 5 || a <= 40) {
